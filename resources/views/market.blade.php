...
<style>
    #main_menu li:nth-child(5) a span,
    #main_menu li:nth-child(5) a i {
...
<div class="container m-auto">
    ...
    <div class="flex justify-between mt-6 mb-4">
        <h1 class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight"> Brand Collection
        </h1>
        <a href="#" class="text-blue-400 hover:text-blue-500"> See all</a>
    </div>
        ...
        <div class=" p-6 space-y-3">
            <div>
                ...
                <input placeholder="Your Name"
                    class="bg-gray-100 dark:bg-gray-600 shadow-none border focus:border-blue-600 mt-2 outline-none px-3 py-2 rounded-md w-full">
            </div>
            <div>
                <label class="mb-0"> Description </label>
                <textarea name="description" rows="3"
                    class="bg-gray-100 shadow-none border mt-2 w-full px-3 py-2 rounded-md focus:border-blue-600 outline-none mt- id="
                    description" placeholder="Please describe your product."></textarea>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="col-span-2">
                    ...
                    <select name="category" id="category"
                        class="bg-gray-100 dark:bg-gray-600 shadow-none border w-full px-3 py-2 rounded-md focus:border-blue-600 outline-none mt-2">
                ...
                <div>
                    <div>
                        ...
                        <input placeholder="0.00" type="number"
                            class="bg-gray-100 dark:bg-gray-600 shadow-none border focus:border-blue-600 mt-2 outline-none pl-3 py-2 rounded-md w-full">
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-3 gap-4">
...
<div id="offcanvas-preview" uk-offcanvas="flip: true; overlay: true">
    <div class="uk-offcanvas-bar lg:w-5/12 w-full dark:bg-gray-700 dark:text-gray-300 p-0">
        ...
        <div class="p-6">
            ...
            <div class="text-xl font-semibold mb-2"> The Wire Realm Status Audio CB-1 Closed-Back Studio Headphones
                Review</div>
                ...
                <div>
                    ...
                    <div class="flex items-center mt-1 space-x-2">
                        <div class="space-y-1 lgtext-lg text-yellow-400">
                            <ion-icon name="star" role="img" class="md hydrated" aria-label="star">
                            </ion-icon>
                            <ion-icon name="star" role="img" class="md hydrated" aria-label="star">
                            </ion-icon>
                            <ion-icon name="star" role="img" class="md hydrated" aria-label="star">
            ...
            <div>
                <p class="leading-7"> Lorem ipsum dolor sitlaoreet dolore magna aliquam erat volutpat.
                    imperdiet doming id quod mazim placerat facer possim assum. Lorem ipsum dolor sit amet, adipiscing
                    elit <a href="#" class="text-blue-500"> read more</a></p>
            </div>
            ...
            <div class="border-t my-8 py-2">
                ...
                <div class="space-y-5">
                    ...
                    <div class="bg-gray-100 dark:bg-gray-700 p-3 shadow-sm rounded-md text-sm relative">
                        ...
                        <div class="flex justify-between items-baseline">
                            <h3 class="text-black mb-2 flex-1 truncate font-semibold"> Good design , but cold be
                                improved </h3>
                        ...
                        <p>
                            ...
                            tincidunt.. <a href="#" class="text-blue-500"> read more </a>
                        </p>
                    ...
                    <div class="bg-gray-100 dark:bg-gray-700 p-3 shadow-sm rounded-md text-sm relative">
                        ...
                        <div class="flex justify-between items-baseline">
                            <h3 class="text-black mb-2 flex-1 truncate font-semibold"> I liked it , would please add
                                extra </h3>
                            <div class="text-xs"> 2d ago</div>
                        </div>
                        <div class="space-y-1 -mt-2 mb-1 text-sm text-yellow-400">
                ...
                <a href="#"
                    class="bg-red-500 pt-6 pb-2 w-full text-center block from-gray-100 to-white bg-gradient-to-b -mt-4 z-10 relative opacity-95 dark:to-gray-700 dark:from-gray-700">
                    read all </a>
            ...
            <div class="flex justify-center items-center space-x-3">
                <a href="#"
                    class="bg-pink-100 flex font-bold hidden  hover:text-white inline-block items-center lg:block max-h-10 px-9 py-2 rounded-full text-pink-500 dark:bg-gray-800">
                    <ion-icon name="person" class="-mb-1 mr-1 opacity-90 text-xl"></ion-icon> Contact seller
                </a>
                <a href="#"
                    class="bg-pink-500 flex font-bold hidden hover:bg-pink-600 hover:text-white inline-block items-center lg:block max-h-10 px-9 py-2 rounded-full text-white">
